...
var faroviteBook = Book(title: "Игра престолов", author: "Джордж Мартин", pages: 700, price: 750)
print("Моя любимая книга - \(faroviteBook.title), автор \(faroviteBook.author). Книга довольно большая - целых \(faroviteBook.pages) страниц, а стоит \(faroviteBook.price)")
/*:
