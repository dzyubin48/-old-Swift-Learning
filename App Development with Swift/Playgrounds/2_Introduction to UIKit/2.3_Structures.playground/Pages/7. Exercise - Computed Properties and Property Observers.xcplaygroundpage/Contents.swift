...
var value = Height(heightInInches: 6)
print(value.heightInCentimeters)
print(value.heightInInches)
value.heightInInches = 15
print(value.heightInInches)
print(value.heightInCentimeters)

var value2 = Height(heightInCentimeters: 100)
print(value2.heightInCentimeters)
print(value2.heightInInches)
value2.heightInCentimeters = 50
print(value2.heightInCentimeters)
print(value2.heightInInches)
