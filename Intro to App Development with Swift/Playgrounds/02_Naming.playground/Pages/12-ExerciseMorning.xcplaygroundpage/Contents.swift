...
let allTimeSpent = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let mainActivityTimeSpent = brushTeeth + chooseClothes + shower + fixLunch
let secondaryActiviryTimeSpent = uploadPhotos + goJogging + finishHomework
/*:
...
*/
let myActivityTimeSpent = brushTeeth + chooseClothes + shower
