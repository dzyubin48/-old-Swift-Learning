...
ricketyRope.addLoadToBasket(loadWeight: sherlock)
ricketyRope.addLoadToBasket(loadWeight: sherlock)
ricketyRope.addLoadToBasket(loadWeight: sherlock)
ricketyRope.canHandleAdditionalLoad(sherlock)

bigRicketyRope.addLoadToBasket(loadWeight: food)
bigRicketyRope.addLoadToBasket(loadWeight: food)
bigRicketyRope.addLoadToBasket(loadWeight: food)
bigRicketyRope.canHandleAdditionalLoad(food)
/*:
 - callout(Exercise):
