...
print("Votes for chocolate fabric = \(chocolateVotes) \nVotes for beach = \(beachVotes)")

if chocolateVotes > beachVotes {
    print("Chocolate fabric won!")
} else {
    print("Beach won!")
}
/*:
 ...
 */
func printResults(withVotes: [SchoolMascotOption]) {
    var marmotVotes = 0
    ...
    print("Mascot votes: \nMarmot = \(marmotVotes) \nSalamander = \(salamanderVotes) \nNeither = \(neitherVotes)")
}
printResults(withVotes: mascotVotes)
